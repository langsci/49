...
which can be implemented as a {\it re-entry} of some solutions
...
Working \todo{3.5.1 cannot remain the only subsection of 3.5} with simulations has obvious advantages for 
