...
The teleporting setup enables \todo{'some' was deleted here to fit the line} fascinating 
...
and meaning can evolve and be acquired ab initio\todo{removed italics here}. 
...
be close to the salt and my pronunciation of the word `salt'
...
context to find the referent (see \tabref{tab:2:findthereferent}).\todo{I inserted `(see ...)' here)} 
...
\end{tabular}
\end{table}
\todo{Table 2.1 table needs a caption}
...
processes of conceptualisation and interpretation are necessarily \todo{Word order changed to fit line.}
