...
The \todo{This intro is way to long, please include another \textbackslash section} previous chapter laid the perceptual groundwork 
...
since the onset \todo{beginning was replaced with onset here to fit the line} of thought, not only because it is one
