...
combinations of categories. Words like \smplenquote{blue}, \smplenquote{light} or
\smplenquote{square} name such categories. We not only need a way 
...
If I say \dblenquote{the wine glass on the table}, I expect 
...
with {\itshape categorisation organs}, small neuronal circuits
capable of performing 
the mapping of some idealised universal form onto
reality. Consequently the human genome
must include a set of {\itshape concept genes} which regulate how each of 
...
and the correct use of the word \smplenquote{because}, the proper
...
Almost any physical object can be called \smplenquote{large} in 
...
like \smplenquote{left of one segment in the series}, or \smplenquote{the left-most object}. 
