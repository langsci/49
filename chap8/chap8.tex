...
papers and excerpts from books about language, meaning and their origins. These readings included: \todo{The readings are referred to, but they do not follow after the colon}
...
the server, call me on:
	+33-1-42-78-73-88 \todo{If this was a private number, we would not show it here.}
Bye,
	A
\end{mail}
...
By mid July,\todo{removed `both' here} the basic infrastructure, the teleportation mechanisms and the semiotic dynamics were running 
...
Nevertheles, various publications were \todo{Here the rest of the sentence seems to have disappeared.}
