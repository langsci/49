...
The \todo{The intro is too long} problem how a physically embodied situated agent
...
We see that words for \todo{`the' deleted here to fit the line} basic distinctions have further established
...
Despite \todo{removed `the' here to fit the line} additional complication of mutually 
