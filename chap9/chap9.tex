...
being in the world. Chances are your own sense of order is already someone elses N01SE.\todo{quotations are not set in italics, see GSR}
\end{quotation}
%\begin{figure}[htbp]
...
We pick up the dialog on the 25 February 2000. Until that date the forum was very active both 
...
A group of University of Hull students (with names like {\it Trash}, {\it yeah8a8y}, {\it schedski}) 
...
% \rule{0.8\textwidth}{.4pt}
\end{mail}
\todo{removed one \textbackslash rule from the last entry. Also, why is \textbackslash rule set to .8 of textwidth?!}
...
Left: Top and pixilated eye of a spectator. Right: the main colours that 
...
to collect data about colour category prototypes and names from human speakers in order to gather more data
