...
the lexicon of one agent.}}\todo[inline]{barely readable at 100\%. Do we need to change s.th. here?}
\end{figure}
...
\subsection{Meta-strategies for generating new lexico-grammatical strategies}
