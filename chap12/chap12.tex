...
\end{enumerate}
This Darwinian dynamic is already active in the operation of language strategies, since \todo{replaced `because' with `since' here to fit the line} a strategy regulates the 
...
Recall that three internal factors were used \todo{replaced `started' with `began' here to fit the line}
...
\enlargethispage{1\baselineskip}\begin{itemize}
