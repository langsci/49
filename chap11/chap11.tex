...
\subsection{Semiotic networks}\todo{This used to be set in a \textbackslash bfshape and not in a subsection}
...
\begin{figure}[htbp]
  \centerline{\includegraphics[width=\textwidth]{chap11/figs/grounding-comparison.pdf}}
